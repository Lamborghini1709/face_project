...
# classifier_model = os.path.dirname(__file__) + "/models/classifier_align_en_final_0401.pkl"
classifier_model = os.path.dirname(__file__) + "/models/classifier_align_en_final_0404.pkl"
debug = False
...
class Recognition:
    ...
    def identify(self, image):
        ...
        for i, face in enumerate(faces):
            ...
            face.name ,prob, sorted_predictions = self.identifier.identify(face)

        return faces,prob, sorted_predictions
...
class Identifier:
    ...
    def identify(self, face):
        if face.embedding is not None:
            ...
            return self.class_names[best_class_indices[0]],prob,np.sort(predictions)
